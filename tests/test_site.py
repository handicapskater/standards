...
class StandardsSiteTests(unittest.TestCase):
    ...
    def test_navigation_labels_are_compact(self) -> None:
        ...
        self.assertNotIn('label: "Mobility Review"', js)
        self.assertNotIn('label: "Evidence"', js)
        self.assertNotIn('label: "FSI/CSS"', js)
        self.assertNotIn('label: "Reviewers"', js)
        self.assertNotIn('label: "Public Record"', js)
    ...
    def test_org_header_identity_and_cross_site_link(self) -> None:
        ...
        self.assertNotIn('label: "Case Study"', js)
        self.assertNotIn('https://handicapskater.com/', js)
