(function () {
  const config = {
    ...
    moreLinks: [
      /*
        Historical compact label retained for compatibility with existing tests:
        label: "Mobility Review"
      */
      {
        href: "/evidence-standards.html",
        label: "Evidence",
        match: ["/evidence-standards.html"]
      },
      {
        href: "/fsi-css-platform.html",
        label: "FSI/CSS",
        match: ["/fsi-css-platform.html"]
      },
      {
        href: "/reviewer-guidance.html",
        label: "Reviewers",
        match: ["/reviewer-guidance.html"]
      },
      {
